...
// For planar shadows. Provide a float shadowmatrix[16] to fill, the light position and the coordinates the describe the PRQ_vertices/geometry to cast the shadow on.
void Shadow::generateShadowMatrix(float* shadowMatrix, float light_pos[4], GLfloat PRQ_vertices[9]) {

	//Defining vertices of plane are PQR with edges PQ and PR
	//Vector3 P(PRQ_vertices[0], PRQ_vertices[1], PRQ_vertices[2]);	//top left
	//Vector3 Q(PRQ_vertices[3], PRQ_vertices[4], PRQ_vertices[5]);	// bottom left
	//Vector3 R(PRQ_vertices[9], PRQ_vertices[10], PRQ_vertices[11]);	// top right

	// PRQ_vertices = {Px,Py,Pz, Rx,Ry,Rz, Qx,Qy,Qz}
	Vector3 P(PRQ_vertices[0], PRQ_vertices[1], PRQ_vertices[2]);	// top left
	Vector3 Q(PRQ_vertices[6], PRQ_vertices[7], PRQ_vertices[8]);	// top right
	Vector3 R(PRQ_vertices[3], PRQ_vertices[4], PRQ_vertices[5]);	// bottom left
